...
export function ServiceIcon({ type }: { type: string }) {
  ...
  if (type === "automation") return <svg viewBox="0 0 32 32" aria-hidden="true" {...common}><rect x="3" y="5" width="8" height="8" rx="1" /><rect x="21" y="19" width="8" height="8" rx="1" /><path d="M11 9h6a4 4 0 0 1 4 4v6M21 23h-6a4 4 0 0 1-4-4v-6" /></svg>;
